...
var assertUrlIsValid = function(url) {
  ...
  // TODO Really chech that the url is valid.
...
if(require.main == module) {
	...
	.option('-u, --url <url_to_html_file>', 'Url to index.html', clone(assertUrlIsValid), "")
        .parse(process.argv);
	
    var checkJson;
    if (program.file != "" && program.url != "") {
      console.log("Please, specify only one of --url or --file parameters.");
      process.exit(1);
    }
    else if (program.url == "") {
